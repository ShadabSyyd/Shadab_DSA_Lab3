...
public class BalancedCoreCheckerAlgorithmClass {

	private String expression;	
	private Result result;
	
	public BalancedCoreCheckerAlgorithmClass(String expression) {
	...
	public Result check(){
	    ...
	    Set<Character> openBracketsSet= BracketsManager.getOpenBracketCharsSet();
